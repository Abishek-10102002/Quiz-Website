...
const optionList = document.querySelector('.option-list');
 ...
 function optionSelected(answer) {
    var userAnswer = answer.textContent.trim();
    var correctAnswer = questions[questionCount].answer.trim();
...
function showResultBox(){
    ...
    let progressStartValue = -1;   //extend case in case they score 0 it will run cont.
